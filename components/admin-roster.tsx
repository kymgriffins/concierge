...
export function AdminRoster() {
  ...
  const [form, setForm] = useState<Partial<RosterShift>>({
  ...
  const submit = async (e: React.FormEvent) => {
    ...
    try {
      if (editingId) {
        await MockAPI.updateRosterShift(
          editingId,
          form as Partial<RosterShift>,
        );
      } else {
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Schedule staff shifts and assign responsibilities
          </p>
        </div>
        <div>
          ...
          <CardContent>
            ...
            >
              ...
              <Select
                ...
                onValueChange={(v) =>
                  setForm({ ...form, shift: v as RosterShift["shift"] })
                }
              >
