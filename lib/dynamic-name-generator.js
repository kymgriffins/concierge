...
module.exports.generateRandomContact = (company) => nameGenerator.generateContact(company);
module.exports.generateRandomNames = (count) => nameGenerator.generateMultipleNames(count);
module.exports.generateRandomContacts = (count, companies) => nameGenerator.generateMultipleContacts(count, companies);
